...
SELECT * FROM usuarios_lenguajes WHERE nombre LIKE '%a%';
...
SELECT NOMBRE, COUNT(*) FROM usuarios_lenguajes WHERE lenguaje IS NOT NULL GROUP BY nombre;



-- Ejercicio 22: Encontrar el lenguaje con más caracteres.
SELECT lenguaje FROM usuarios_lenguajes WHERE LENGTH(lenguaje) = (
...
SELECT *, edad-(SELECT AVG(edad) FROM usuarios_lenguajes) AS diferencia_edad_promedio FROM usuarios_lenguajes;
